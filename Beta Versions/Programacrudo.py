...
cpu = input("Ingrese la CPU: ")
monitor = input("Ingrese el monitor: ")
diadema = input("Ingrese la diadema: ")
pin = input("Ingrese el PIN: ")

# Nombre del archivo modificado
nombre_archivo = 'Acta_' + nombre

# Modificar el documento
modificar_documento(archivo_word, nombre, cedula, cpu, monitor, diadema, pin, nombre_archivo)
